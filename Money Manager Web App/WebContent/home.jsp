...
<body>
	<ul class="menu-bar">
  		<li style="float: left;"><a href="" class="list-links">Home</a></li>
		...
		<li style="float: left;"><a href="options.jsp" class="list-links">Options</a></li>
  		<li class="dropdown-right">
  			<a href="#user" class="list-links"><c:out value="${sessionScope.username}"/></a>
	...
	<h1 style="font-size: 400%; text-align: center;"> HOME PAGE! </h1>
